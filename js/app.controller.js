  ...
  var strHTML = locs
    .map((loc) => {
      ...
      if (gUserPos) {
        ...
        distanceStr = `Distance from your Location: ${distance} KM`;
      }
      return `
        <li class="loc ${className}" data-id="${loc.id}">
            ...
            <p class="muted">
                ...
                ${distanceStr ? `<p class=muted">${distanceStr} </p>` : ""}
            </p>
            <div class="loc-btns">     
...
function onAddLoc(geo) {
  ...
  if (!locName) return;
  if (!geo?.lat || !geo?.lng) {
    flashMsg("Invalid geo data: lat/lng missing");
    console.log("GEO ERROR:", geo);
    return;
  }
